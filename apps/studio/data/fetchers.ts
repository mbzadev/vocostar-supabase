...
// [VOCOSTAR] Self-hosted: pg-meta connects directly to Postgres via DB_URL env var (not via encrypted connection string)
...
export function isValidConnString(connString?: string | null) {
  ...
  // [VOCOSTAR] Self-hosted: pg-meta connects via DB_URL env var, no connection string needed
