...
export const StorageSettings = () => {
  ...
  // [VOCOSTAR] Optional chaining to prevent crash when config loads partially
  ...
  const onSubmit: SubmitHandler<z.infer<typeof FormSchema>> = async (data) => {
    ...
    updateStorageConfig({
      ...
      features: {
        ...
        // [VOCOSTAR] Optional chaining: s3Protocol may not be defined in self-hosted
        s3Protocol: { enabled: config?.features?.s3Protocol?.enabled ?? false },
      },
    })
  }
