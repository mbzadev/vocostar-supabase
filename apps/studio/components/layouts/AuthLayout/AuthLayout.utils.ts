...
export const useGenerateAuthMenu = (): ProductMenuGroup[] => {
  ...
  return [
    ...
    ...(authenticationEmails && (IS_PLATFORM || IS_SELF_HOSTED)
      ? [
          {
            title: 'Notifications',
            items: [
      ...
      : []),
    {
      ...
      items: [
        ...
        ...((IS_PLATFORM || IS_SELF_HOSTED)
          ? [
              ...(authenticationSignInProviders // Removed existing !IS_SELF_HOSTED to allow local configuration
                ? [
                    {
