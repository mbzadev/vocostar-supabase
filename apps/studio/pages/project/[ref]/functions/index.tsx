...
import { DOCS_URL, IS_PLATFORM, IS_SELF_HOSTED } from 'lib/constants'
      ...
      <PageSection>
        <PageSectionContent>
          <div className="flex flex-col gap-6">
            ...
            {(!IS_PLATFORM && !IS_SELF_HOSTED) && <FunctionsInstructionsLocal />}
          </div>
        </PageSectionContent>
      </PageSection>
    </PageContainer>
          ...
          <PageHeader size="large">
            <PageHeaderMeta>
              ...
              <PageHeaderAside>
                ...
                {(IS_PLATFORM || IS_SELF_HOSTED) && <DeployEdgeFunctionButton />}
              </PageHeaderAside>
            </PageHeaderMeta>
          </PageHeader>
