...
import { API_URL, BASE_PATH, IS_PLATFORM, IS_SELF_HOSTED, useDefaultProvider } from 'lib/constants'
              ...
              >
                <ProfileProvider>
                  <Head>
                    ...
                    {/* [VOCOSTAR] Skip in self-hosted: API_URL is relative '/api', new URL('/api') would throw */}
